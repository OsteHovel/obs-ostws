...
git clone --recursive https://github.com/Palakis/obs-ostws.git
cd obs-ostws
...
./CI/package-macos.sh
```
This will result in a ready-to-use `obs-ostws.pkg` installer in the `release` subfolder.

## Automated Builds
- Windows : [![Automated Build status for Windows](https://ci.appveyor.com/api/projects/status/github/Palakis/obs-ostws)](https://ci.appveyor.com/project/Palakis/obs-ostws/history)
- Linux & OS X : [![Automated Build status for Linux & OS X](https://travis-ci.org/Palakis/obs-ostws.svg?branch=master)](https://travis-ci.org/Palakis/obs-ostws)
