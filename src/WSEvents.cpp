...
void WSEvents::StreamStatus()
{
	...
	int totalVideoFrames = obs_output_get_total_frames(streamOutput);
	int droppedVideoFrames = obs_output_get_frames_dropped(streamOutput);

	float strain = obs_output_get_congestion(streamOutput);

	int laggedFrames = obs_get_lagged_frames();
	int totalFrames = obs_get_total_frames();
	...
	obs_data_set_int(data, "num-total-frames", totalVideoFrames);
	obs_data_set_int(data, "num-dropped-frames", droppedVideoFrames);
	obs_data_set_int(data, "num-total-frames2", totalFrames);
	obs_data_set_int(data, "num-lagged-frames", laggedFrames);
...
void WSEvents::Heartbeat()
{
	...
	obs_data_set_int(data, "num-total-frames", obs_get_total_frames());
	obs_data_set_int(data, "num-lagged-frames", obs_get_lagged_frames());
